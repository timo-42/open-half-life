...
/// switch out of the way, in the shape [`plan_presses`] presses a door
/// with.
///
...
mod tests {
    ...
    use crate::test_support::{
        ...
        PLAN_PLATROT_TRAVEL, PLAN_STOOD_ON_MAP, PLAN_STOOD_ON_NAME, PLAN_TURN_MAP,
        REACH_GAP_EDGE_X, REACH_GAP_MAP, plan_cost_bsp, plan_ladder_bsp, plan_lift_bsp,
        plan_platrot_alcove_bsp, plan_platrot_bsp, plan_platrot_gate_bsp, plan_stood_on_lift_bsp,
